...
const User = () => {
  ...
  const handleDeleteUser = async(id,e)=>{
    e.preventDefault();
    await axios.delete(`https://smoke-backend.vercel.app/api/v1/admin/User/deleteUser/${id}`, {
      headers: {Authorization: `Bearer ${adminToken}`},
    }).then(res => toast.success('User Deleted')).catch(err => console.log(err));
    fetchData();
  }
                ...
                <tr key={index}>
                  ...
                  <td>
                    ...
                    <span className="flexCont">
                      ...
                      ></i>
                      <i className="fa-sharp fa-solid fa-trash" onClick={(e)=>handleDeleteUser(i._id,e)}></i>
                    </span>
                  </td>
                </tr>
              ))}
