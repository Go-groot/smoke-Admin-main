...
const Login = () => {
  ...
  const submitHandler = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post("https://smoke-backend.vercel.app/api/v1/admin/login" , { email , password })
    ...
    <>
      ...
      >
        <form className="shadow-2xl w-96 mx-3 sm:mx-0 sm:w-4/5 md:w-4/6 lg:w-4/5 xl:w-1/2 flex flex-col items-center bg-white p-5 md:py-10 ">
          <h5 style={{ textTransform: "uppercase" , fontWeight : '900' , fontSize : '30px' }}>SMOKE Admin Panel</h5>
