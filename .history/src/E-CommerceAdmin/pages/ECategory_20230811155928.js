...
const ECategory = () => {
        ...
        <Modal.Body>
          <Form onSubmit={edit ? "" : postHandller}>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" required onChange={(e) => setQuestion(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Answer</Form.Label>
              <Form.Control type="text" required  onChange={(e) => setAnswer(e.target.value)} />
            </Form.Group>
  ...
  const deleteHandler = async (id) => {
    try{
      const res = await axios.delete(`https://smoke-backend.vercel.app/api/v1/faq/643cfaf881cbe6dc7f51092d`)
    }catch{}
  }
