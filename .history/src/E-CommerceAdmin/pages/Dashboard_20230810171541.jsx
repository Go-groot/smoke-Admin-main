...
const Dashboard = () => {
  ...
  const card = [
    ...
    },
    {
      ...
      title: "Total Female",
      number: 100,
      icon: <i className="fa-solid fa-person- text-2xl text-[#3c335d]"></i>,
      bg: "#3c335d",
      link: "/Product",
    },
    {
      ...
      title: "Total User",
      number: 200,
      icon: <i class="fa-solid fa-cart-shopping text-2xl text-[#442d48]"></i>,
      bg: "#442d48",
      link: "/Product",
    },
    {
      ...
      title: "Active User",
      number: 20,
      icon: <i class="fa-solid fa-cart-shopping text-2xl text-[#00755e]"></i>,
      bg: "#00755e ",
      link: "/Product",
    },
    {
      ...
      title: "Total Post",
      number: 20,
      icon: <i class="fa-solid fa-cart-shopping text-2xl text-[#124363]"></i>,
      bg: "#124363 ",
      link: "/Product",
    },
  ];
