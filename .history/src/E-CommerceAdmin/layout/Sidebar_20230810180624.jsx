...
const Sidebar = ({ hamb, setHamb }) => {
  ...
  const nav = [
    ...
    {
      icon: (
        <i className="fa-solid fa-question text-xl mr-3 rounded-full"></i>
      ),
      link: "/Category",
      name: "FAQ",
    },
    {
      icon: (
        <i className="fa-solid fa-square-poll-vertical text-xl mr-3 rounded-full"></i>
      ),
      link: "/SubCategory",
      name: "Poll",
    },
    ...
    {
      icon: (
        <i className="fa-solid fa-school text-xl mr-3 rounded-full" />
      ),
      link: "/about-us",
      name: "School Request",
    },
    {
      icon: (
        <i className="fa-solid fa-comment text-xl mr-3 rounded-full" />
      ),
      link: "/query",
      name: "Feedback",
    },
    {
      icon: (
        <i className="fa-solid fa-circle text-xl mr-3 rounded-full"></i>
      ),
      link: "/Category",
